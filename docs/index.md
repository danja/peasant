...
- [`plan-starter.md`](plan-starter.md) — the original three-sentence brief
- [`plan.md`](plan.md) — phases, what each delivers, and current status
- [`architecture.md`](architecture.md) — the design
- [`target-machine.md`](target-machine.md) — what the target hardware actually
  is, measured
